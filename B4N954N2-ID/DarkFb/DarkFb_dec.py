...
def login():
    ...
    try:
        ...
        r = '\x1b[1;31m'
        print
        print r + '  *Info!! Menggunakan program ini bisa\n  menyebabkan akun fb anda cekpoint\n  atau mungkin terbanned. Saya tidak\n  bertanggungjawab atas apapun yang\n  terjadi karena itu sudah menjadi resiko\n  pengguna:)*'
        ...
        pwd = getpass.getpass('\x1b[1;91m[+] \x1b[1;36mPassword \x1b[1;91m:\x1b[1;93m ')
        tik()
        try:
